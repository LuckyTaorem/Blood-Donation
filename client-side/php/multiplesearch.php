...
{
    echo "<tr><td>".ucwords(strtolower($row2['name']))."</td><td><a href=".'mailto:'.$row2['email'].">".strtolower($row2['email'])."</a></td><td>".strtoupper($row2['bg'])."</td><td>{$row2['phn']}</td><td>".ucwords(strtolower($row2['city']))."</td><td>{$row2['pin']}</td><td>{$row2['address']}</td></tr>\n";
}
}else{
